...
public class TestScanner {
	...
	public static void main(String[] args) {
		...
		System.out.println("Enter taxtable income: $");
		taxableIncome = sc.nextInt();

		while (taxableIncome != SENTINEL) {
			if (taxableIncome > 40000) {
				taxPayable = TAX_RATE_40K * taxableIncome;	
				
			} else if (taxableIncome > 30000) {
				taxPayable = TAX_RATE_30K * taxableIncome;
				
			} else if (taxableIncome > 20000) {
				taxPayable = TAX_RATE_20K * taxableIncome;
